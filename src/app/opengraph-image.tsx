...
export const alt = "Mind Calendar — your time, in your pod";
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <span style={{ fontSize: 60, fontWeight: 700, letterSpacing: -1 }}>Calendar</span>
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        Your time, in your pod · built on Solid
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        A privacy-first calendar built on Solid Pods — every event lives in your pod as plain
        Turtle, so no central server ever sees your schedule.
      </div>
