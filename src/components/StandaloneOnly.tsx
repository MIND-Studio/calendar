...
/**
 * Renders its children only when Calendar runs **standalone**. Inside the Mind
 * shell (brokered mode) it renders nothing — the shell already provides the
 * chrome (app title, navigation, app launcher, theme), so Calendar's own
 ...
 * overlay (it clears on `mind:ready`, which Calendar fires only after this resolves).
 */
